...
function generateXML() {
    const element = document.getElementById("generated-xml");
    element.textContent = defaultXMLContent;
}

const copy = function () {
    const xmlContent = document.getElementById("generated-xml").textContent;
